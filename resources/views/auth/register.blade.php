    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card regform">
                <div class="card-header text-center script h2">{{ __('Register') }} </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" minlength='4' maxlength='20' autofocus>
